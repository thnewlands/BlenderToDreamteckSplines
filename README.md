...
3. A new option will appear in the export menu.

![image](https://user-images.githubusercontent.com/4378629/188004531-dfe5625d-e9a4-4e23-8afa-73b23f0a14f0.png)

4. From there select your BezierCurve object and run the export. 

5. You will be able to import your new bezier curves as csv through Dreamteck's tool panel. 
...
6. Done! You should see your spline in Unity.
